...
export const ROUTES: RouteInfo[] = [
    ...
    {
        path: '/', title: 'Starter Page', icon: 'mdi mdi-gauge', class: '', label: '', labelClass: '', extralink: false, submenu: []
    },
    {
        path: '/Employee', title: 'Employees', icon: 'mdi mdi-gauge', class: '', label: '', labelClass: '', extralink: false, submenu: []
    },
    // {
    ...
    // },
    {
        ...
        submenu: [
            { path: '/admin/roles', title: 'Roles', icon: '', class: '', label: '', labelClass: '', extralink: false, submenu: [] }
